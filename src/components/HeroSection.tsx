...
const HeroSection = () => {
  ...
  return <section id="hero" className="relative overflow-hidden pt-10">
      {/* Content */}
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row items-start gap-6 md:gap-10">
          ...
          type: "spring",
          stiffness: 200
        }} src={momoAvatar} alt="MOMO" className="w-28 h-28 md:w-36 md:h-36 rounded-2xl border-4 border-background shadow-card-hover" />
          ...
          <div className="flex-1 pt-2 md:pt-8">
            ...
            delay: 0.45
              ...
              <button onClick={() => scrollTo("learning-hub")} className="bg-gradient-hero text-primary-foreground font-semibold px-6 py-3 rounded-full shadow-glow hover:shadow-card-hover transition-all hover:-translate-y-0.5">
                📚 Explore Learning Hub
              </button>
              <button onClick={() => scrollTo("ai-chat")} className="bg-gradient-cta text-navy font-semibold px-6 py-3 rounded-full hover:opacity-90 transition-all hover:-translate-y-0.5">
                🤖 Chat with MOMO AI
              </button>
            </motion.div>
          </div>
